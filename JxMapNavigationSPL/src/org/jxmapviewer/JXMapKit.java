...
public class JXMapKit extends JPanel
{
	...
	public JXMapKit()
	{
		...
		try
		{
			File minusFile = new File("./resources/images/minus.png");
			Icon minusIcon = new ImageIcon(minusFile.toURI().toURL());
			this.zoomOutButton.setIcon(minusIcon);
			this.zoomOutButton.setText("");
			File plusFile = new File("./resources/images/plus.png");
			Icon plusIcon = new ImageIcon(plusFile.toURI().toURL());
...
//				Point2D centerpos = map.getTileFactory().geoToPixel(mapCenterPosition, map.getZoom());
	...
	private void initComponents()
	{
		...
		File plusIcon = new File("./resources/images/plus.png");
		try {
			zoomInButton.setIcon(new ImageIcon(plusIcon.toURI().toURL()));
		...
		File minusFile = new File("./resources/images/minus.png");
		try {
			zoomOutButton.setIcon(new ImageIcon(minusFile.toURI().toURL()));
		} catch (MalformedURLException e) {
